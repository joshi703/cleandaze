    ...
    <div className="container mx-auto px-4 py-8">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
        <div>
          ...
          <p className="text-gray-600">Manage your CLEANDAZE platform</p>
        </div>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
        ...
        <TabsContent value="overview" className="space-y-4">
          <Card>
            ...
            <CardContent>
              <p>Welcome to your CLEANDAZE admin dashboard. Here you can manage all aspects of your platform.</p>
        ...
        <TabsContent value="settings">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Configure your CLEANDAZE platform settings
              </CardDescription>
            </CardHeader>
            <CardContent>
              {settingsLoading ? (
